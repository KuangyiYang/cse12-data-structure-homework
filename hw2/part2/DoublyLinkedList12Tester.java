...
{
  private DoublyLinkedList12<Integer>  sizeZero ;
  private DoublyLinkedList12<Integer>  sizeOne ;
  private DoublyLinkedList12<Integer>  sizeTwo ;
  private DoublyLinkedList12<Integer>  sizeThree;
  private DoublyLinkedList12<String> stringList ;
  ...
  public void setUp()
  {
    sizeZero = new DoublyLinkedList12<Integer>(); 
    sizeOne = new DoublyLinkedList12<Integer>();  
    sizeOne.add (0,1);  //0 is an index, 1 is an element to add.
    sizeTwo = new DoublyLinkedList12<Integer>();
    ...
    stringList = new DoublyLinkedList12<String>() ;
    stringList.add(0, "head") ;
    stringList.add(1, "tail") ;
    
    sizeThree = new DoublyLinkedList12<Integer>();
    for (int i = 3; i > 0; i--)
    {
      sizeThree.add(0, i);
    }
  ...
  {
    assertEquals("Check head of sizeOne", new Integer(1), sizeOne.get(0)) ;
    assertEquals("Check head of sizeTwo", new Integer(1), sizeTwo.get(0)) ;
  }
  ...
  {
    assertEquals("Check Tail", new Integer(2), sizeTwo.get(1));
  }
  ...
  {
    assertEquals("Test get0th", new Integer(1), sizeTwo.get(0)) ;
    assertEquals("Test get1st", new Integer(2), sizeTwo.get(1)) ;
  }
  ...
  {
    assertEquals("Test return of remove sizeOne", new Integer(1), sizeOne.remove(0)) ;
    assertEquals("Test return of remove sizeTwo", new Integer(2), sizeTwo.remove(1)) ;
  }
  ...
  {
    ListIterator<Integer> iter = sizeZero.listIterator();
    iter.add(1);
    iter.add(2);
    iter.add(3);
    iter.previous();
    assertEquals("Check add", new Integer(2), iter.previous());
  ...
  ListIterator<Integer> iter = sizeThree.listIterator();
  ...
  public void testIteratorNext() {
    ListIterator<Integer> iter = sizeTwo.listIterator();
    assertEquals("next is 1", new Integer(1), iter.next());
  }
  ...
  public void testIteratorRemove() {
    ...
    iter.next();
    iter.remove();
    assertEquals("element at index 0 of sizeThree is 2", new Integer(2), sizeThree.get(0));
  ...
  ListIterator<Integer> iter = sizeTwo.listIterator();
    ...
    iter.set(new Integer(5));
    assertEquals("first element of sizeTwo is 5", new Integer(5), sizeTwo.get(0));
    iter.next();
    iter.previous();
    iter.set(10);
    assertEquals("second element of sizeTwo is 10", new Integer(10), sizeTwo.get(1));
  }
